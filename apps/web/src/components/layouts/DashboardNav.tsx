...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { href: '/dashboard/sustainability', label: 'Overview', icon: LayoutDashboard, perm: 'sustainability:read' },
      { href: '/dashboard/sustainability/programs', label: 'Programs', icon: Recycle, perm: 'sustainability:read' },
      { href: '/dashboard/sustainability/goals', label: 'Goals', icon: Target, perm: 'sustainability:read' },
  ...
  },
  {
    ...
    perm: 'carbon:read',
    items: [
      { href: '/dashboard/carbon', label: 'Dashboard', icon: LayoutDashboard, perm: 'carbon:read' },
      { href: '/dashboard/carbon/emissions', label: 'Activity Data', icon: FileText, perm: 'carbon:read' },
      { href: '/dashboard/carbon/emission-factors', label: 'Emission Factors', icon: CalculatorIcon, perm: 'carbon:read' },
      { href: '/dashboard/carbon/scopes?scope=1', label: 'Scope 1', icon: Layers, perm: 'carbon:read' },
      { href: '/dashboard/carbon/scopes?scope=2', label: 'Scope 2', icon: Layers, perm: 'carbon:read' },
      { href: '/dashboard/carbon/scopes?scope=3', label: 'Scope 3', icon: Layers, perm: 'carbon:read' },
      { href: '/dashboard/carbon/targets', label: 'SBTi Targets', icon: TargetIcon, perm: 'carbon:read' },
      { href: '/dashboard/carbon/projects', label: 'Carbon Projects', icon: Rocket, perm: 'carbon:read' },
      { href: '/dashboard/carbon/offsets', label: 'Carbon Offsets', icon: TreePine, perm: 'carbon:read' },
      { href: '/dashboard/carbon/reports', label: 'Reports', icon: FileBarChart, perm: 'carbon:read' },
